...
clausulaCelda (x, y) tablero = if esCeldaFinal
  ...
  where
    ...
    matchingPipes = if (x == 1 && y == 1) then [[-(pipeClause + 6), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 6), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (x == 1 && y == numFilas) then [[-(pipeClause + 5), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                               [[-(pipeClause + 5), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (x == numFilas && y == 1) then [[-(pipeClause + 4), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 4), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (x == numFilas && y == numFilas) then [[-(pipeClause + 3), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 3), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (x == 1) then [[-(pipeClause + 6), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 6), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 5), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                               [[-(pipeClause + 5), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 1), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ 
                                                [[-(pipeClause + 1), -(colorClauses !! i), ((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), (colorClauses !! i), -((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (x == numFilas) then [[-(pipeClause + 4), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 4), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 3), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 3), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 1), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ 
                                                [[-(pipeClause + 1), -(colorClauses !! i), ((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), (colorClauses !! i), -((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (y == 1) then [[-(pipeClause + 6), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 6), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 4), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 4), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 2), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 2), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else if (y == numFilas) then [[-(pipeClause + 3), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 3), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 5), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                               [[-(pipeClause + 5), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                 [[-(pipeClause + 2), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 2), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                  else [[-(pipeClause + 1), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ 
                                                [[-(pipeClause + 1), -(colorClauses !! i), ((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), (colorClauses !! i), -((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                        [[-(pipeClause + 2), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 2), -(colorClauses !! i), (((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), (colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                        [[-(pipeClause + 3), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                        ...
                        [[-(pipeClause + 5), -(colorClauses !! i), ((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                               [[-(pipeClause + 5), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                        [[-(pipeClause + 6), -(colorClauses !! i), ((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                                                [[-(pipeClause + 6), -(colorClauses !! i), (((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 6), (colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
    notMatchingPipes = if (x == 1 && y /= 1 && y /= numFilas) then [[-(pipeClause + 6), -(colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), -(colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), -(colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                        else if (x == numFilas && y /= 1 && y /= numFilas) then [[-(pipeClause + 4), -(colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), -(colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), -(colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                        else if (y == 1 && x /= 1 && x /= numFilas) then [[-(pipeClause + 6), -(colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 4), -(colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), -(colorClauses !! i), -((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                        else if (y == numFilas && x /= 1 && x /= numFilas) then [[-(pipeClause + 5), -(colorClauses !! i), -(((x - 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), -(colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 2), -(colorClauses !! i), -((x * numFilas + (y - 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                        else if (x /= 1 && x /= numFilas && y /= 1 && y /= numFilas) then [[-(pipeClause + 6), -(colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 5), -(colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 1), -(colorClauses !! i), -(((x + 1) * numFilas + y) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++
                              [[-(pipeClause + 4), -(colorClauses !! i), -((x * numFilas + y - 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++ [[-(pipeClause + 3), -(colorClauses !! i), -((x * numFilas + y + 1) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]] ++  [[-(pipeClause + 2), -(colorClauses !! i), -((x * numFilas + (y + 1)) * numFilas + i - ((numFilas * numFilas) + numFilas))] | i <- [0..numFilas-1]]
                        else []
